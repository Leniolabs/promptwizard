...
class semanticSimilarity:
    def __init__(self, test_cases, number_of_prompts, model_test, model_test_temperature, model_test_max_tokens, model_generation, model_generation_temperature, prompts, best_prompts, model_embedding):
    ...
    def calculate_embedding(self, test_case):
        test_case['embedding'] = openai_call.create_embedding(self.model_embedding, test_case['output'])
    ...
    def test_candidate_prompts(self):
        ...
        with concurrent.futures.ThreadPoolExecutor(max_workers=10) as executor:
            ...
            for prompt in self.prompts:
                ...
                for test_case in self.test_cases:
                    ...
                    embedding_response = openai_call.create_embedding(self.model_embedding, result_content)
        ...
        cost = cost + cost_input + cost_output + cost_embeddings
